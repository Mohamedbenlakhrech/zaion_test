...
// Parse and format the trip string entry to DepTime;DepCity;ArrTime;ArrCity;
...
/**
 * Apply the Dijkstra algorithm to the graph to find the shortest path
 * every node represent the city
